# Generated by Django 4.0 on 2023-11-19 12:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('link', models.CharField(blank=True, max_length=200, null=True, verbose_name='Простая ссылка')),
                ('bitlink', models.CharField(blank=True, max_length=200, null=True, verbose_name='Bitly ссылка')),
                ('transitions', models.IntegerField(blank=True, default=0, null=True, verbose_name='Количество переходов по ссылке')),
            ],
        ),
        migrations.CreateModel(
            name='Storage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(blank=True, null=True, verbose_name='Начало хранения')),
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Окончание хранения')),
                ...
                ('send_message', models.BooleanField(default=False, verbose_name='Отправить уведомление')),
